  ...
  return (
    <Box
      ...
      sx={{
        ...
        gap: 2,
        minWidth: '200px', // Largura mínima para pequenos dispositivos
    ...
    >
      ...
      <TextField
      sx={{border: 'solid 1px black', '&::focus': {borderColor: 'black', borderRadius:'0'}, '& label': { fontWeight: 'bold', color: 'black' } }}
        label="Nome"
        fullWidth
        name="name"
        value={formData.name}
